...
# ╔═╡ 84c85bba-bf17-11ec-18f3-d1628a9ce5f2
using Catalyst, DifferentialEquations, Plots, Latexify

# ╔═╡ d8a3d967-2486-41f9-94e7-3810836f0635
...
# ╔═╡ f220830d-b804-4592-9bf6-7c4549cdf121
g = Graph(repressilator)

# ╔═╡ d2d6711f-ac00-47f5-ac4d-7e01632e444d
odesys = convert(ODESystem, repressilator)

# ╔═╡ 136a7193-1e28-44f0-a2be-d270b2778d1a
...
# ╔═╡ fa5c09d9-7c0b-494d-a98c-4ea3a61f1f80
tspan = (0., 10000.);

# ╔═╡ ac6bc894-6919-42a9-ab82-fdae5196cd4a
oprob = ODEProblem(repressilator, u₀map, tspan, pmap)

# ╔═╡ 16235d48-e69d-41c5-898c-8b781562e526
sol = solve(oprob, Tsit5(), saveat=10.);

# ╔═╡ 851e9d15-6391-4f9b-b06c-d3221459b81c
plot([sol[i,:] for i in 4:6])

# ╔═╡ 92d7d72a-f726-4792-8321-2d486b7ec231
phase=[Tuple([sol[i,j] for i in 4:6]) for j in 1:1001];

# ╔═╡ 649035fe-0afd-456c-80e9-7c59f1b997ee
plot(phase[600:end])

# ╔═╡ d8f3a904-bdea-4ac1-9a41-276c14e2df3f
begin
...
# ╔═╡ 9723de80-f8df-4b94-900e-a62e32afaa31
convert(ODESystem,model)

# ╔═╡ bcc98452-457c-4b3f-8348-8ff48070d500
begin
tt = @reaction_network tt begin
	a,∅ --> X
	b,X --> ∅
	c,A + B --> AB
end a b c
...
# ╔═╡ aeb07526-ed55-453a-a6f7-d514c87f919e
convert(ODESystem,tt)
